...
有些平台会检测关键词（比如render)，可以使用打包好的`dockerfile`文件解决,建议都fork仓库再部署，防止封号。项目地址链接：[https://github.com/mjjonone/mjj-docker](https://github.com/mjjonone/mjj-docker)，请先Fork此仓库，再部署Fork的仓库。
